<template>
  <v-list>
    <v-list-item v-for="group in groups" :key="group.id" @click="navigateToGroupchedules(group.id)">
...
export default {
  ...
  setup() {
    ...
    const navigateToGroupchedules = (groupId) => {
